<template>
  <div class="home-page">
    ...
    <main>
      ...
      <section id="servicios" class="services-intro">
      ...
      <section class="promise">
        <div class="promise-image"><img src="https://megaprinter.ec/wp-content/uploads/2024/05/Mesa-de-trabajo-12-copia-4.png" alt="Equipo Megaprinter" /></div>
      ...
      <section class="closing-cta"><span>¿Tu equipo está detenido?</span><router-link to="/repairs">Hagámoslo funcionar <i class="fa-solid fa-arrow-right"></i></router-link></section>
    </main>
...
const services = [
  { number: '01', name: 'Taller técnico', text: 'Mantenimiento y reparación con evaluación profesional.', icon: 'fa-solid fa-screwdriver-wrench', link: '/repairs' },
  { number: '02', name: 'Venta inteligente', text: 'Equipos y suministros seleccionados para tu operación.', icon: 'fa-solid fa-print', link: '/products' },
  { number: '03', name: 'Soporte en sitio', text: 'Atención para empresas sin detener tu jornada.', icon: 'fa-solid fa-building', link: '/repairs' },
]
</script>
